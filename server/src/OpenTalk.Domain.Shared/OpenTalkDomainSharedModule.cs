...
public class OpenTalkDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        OpenTalkGlobalFeatureConfigurator.Configure();
        OpenTalkModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<OpenTalkDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<OpenTalkResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/OpenTalk");

            options.DefaultResourceType = typeof(OpenTalkResource);
        ...
        {
            options.MapCodeNamespace("OpenTalk", typeof(OpenTalkResource));
        });
    }
}
